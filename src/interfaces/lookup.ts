...
export default {
  ...
  PalletTfgridStorageVersion: {
    _enum: ['V1Struct', 'V2Struct', 'V3Struct', 'V4Struct', 'V5Struct', 'V6Struct', 'V7Struct', 'V8Struct', 'V9Struct', 'V10Struct', 'V11Struct', 'V12Struct', 'V13Struct', 'V14Struct', 'V15Struct', 'V16Struct', 'V17Struct']
  },
  /**
   ...
   **/
  PalletDaoError: {
    _enum: ['NoneValue', 'StorageOverflow', 'FarmNotExists', 'NotCouncilMember', 'WrongProposalLength', 'DuplicateProposal', 'NotAuthorizedToVote', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'DuplicateVeto', 'WrongProposalWeight', 'TooEarly', 'TimeLimitReached', 'OngoingVoteAndTresholdStillNotMet', 'FarmHasNoNodes', 'InvalidProposalDuration', 'ThresholdTooLow']
  },
  /**
   * Lookup286: pallet_validator::pallet::Error<T>
   **/
  PalletValidatorError: {
    _enum: ['BadOrigin', 'NotCouncilMember', 'AlreadyBonded', 'StashNotBonded', 'StashBondedWithWrongValidator', 'CannotBondWithSameAccount', 'DuplicateValidator', 'ValidatorNotFound', 'ValidatorNotApproved', 'UnauthorizedToActivateValidator', 'ValidatorValidatingAlready', 'ValidatorNotValidating']
  },
  /**
