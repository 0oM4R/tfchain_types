...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    dao: {
       ...
       **/
      Closed: AugmentedEvent<ApiType, [proposalHash: H256, yes: u32, yesWeight: u64, no: u32, noWeight: u64], { proposalHash: H256, yes: u32, yesWeight: u64, no: u32, noWeight: u64 }>;
      ClosedByCouncil: AugmentedEvent<ApiType, [proposalHash: H256, vetos: Vec<AccountId32>], { proposalHash: H256, vetos: Vec<AccountId32> }>;
      CouncilMemberVeto: AugmentedEvent<ApiType, [proposalHash: H256, who: AccountId32], { proposalHash: H256, who: AccountId32 }>;
      /**
       * A motion was not approved by the required threshold.
       **/
      Disapproved: AugmentedEvent<ApiType, [proposalHash: H256], { proposalHash: H256 }>;
    ...
    smartContractModule: {
       ...
       **/
      ContractGracePeriodEnded: AugmentedEvent<ApiType, [contractId: u64, nodeId: u32, twinId: u32], { contractId: u64, nodeId: u32, twinId: u32 }>;
      /**
       * A Contract grace period is triggered
       **/
      ContractGracePeriodStarted: AugmentedEvent<ApiType, [contractId: u64, nodeId: u32, twinId: u32, blockNumber: u64], { contractId: u64, nodeId: u32, twinId: u32, blockNumber: u64 }>;
      /**
       ...
       **/
      IPsFreed: AugmentedEvent<ApiType, [contractId: u64, publicIps: Vec<TfchainSupportPublicIP>], { contractId: u64, publicIps: Vec<TfchainSupportPublicIP> }>;
      /**
       * IP got reserved by a Node contract
       **/
      IPsReserved: AugmentedEvent<ApiType, [contractId: u64, publicIps: Vec<TfchainSupportPublicIP>], { contractId: u64, publicIps: Vec<TfchainSupportPublicIP> }>;
      /**
       ...
       **/
      NodeContractCanceled: AugmentedEvent<ApiType, [contractId: u64, nodeId: u32, twinId: u32], { contractId: u64, nodeId: u32, twinId: u32 }>;
       ...
       **/
      ServiceContractBilled: AugmentedEvent<ApiType, [serviceContract: PalletSmartContractServiceContract, bill: PalletSmartContractServiceContractBill, amount: u128], { serviceContract: PalletSmartContractServiceContract, bill: PalletSmartContractServiceContractBill, amount: u128 }>;
      /**
       * A Service contract is canceled
       **/
      ServiceContractCanceled: AugmentedEvent<ApiType, [serviceContractId: u64, cause: PalletSmartContractCause], { serviceContractId: u64, cause: PalletSmartContractCause }>;
      /**
    ...
    tfgridModule: {
      ...
      PowerStateChanged: AugmentedEvent<ApiType, [farmId: u32, nodeId: u32, powerState: TfchainSupportPowerState], { farmId: u32, nodeId: u32, powerState: TfchainSupportPowerState }>;
      /**
       * Send an event to zero os to change its state
       **/
      PowerTargetChanged: AugmentedEvent<ApiType, [farmId: u32, nodeId: u32, powerTarget: TfchainSupportPower], { farmId: u32, nodeId: u32, powerTarget: TfchainSupportPower }>;
