...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletTftBridgeEvent extends Enum {
    ...
    readonly type: 'MintTransactionProposed' | 'MintTransactionVoted' | 'MintCompleted' | 'MintTransactionExpired' | 'BurnTransactionCreated' | 'BurnTransactionProposed' | 'BurnTransactionSignatureAdded' | 'BurnTransactionReady' | 'BurnTransactionProcessed' | 'BurnTransactionExpired' | 'RefundTransactionCreated' | 'RefundTransactionsignatureAdded' | 'RefundTransactionReady' | 'RefundTransactionProcessed' | 'RefundTransactionExpired';
  }
  ...
  interface PalletTftPriceEvent extends Enum {
    ...
    readonly type: 'PriceStored' | 'OffchainWorkerExecuted' | 'AveragePriceStored' | 'AveragePriceIsAboveMaxPrice' | 'AveragePriceIsBelowMinPrice';
  }
  ...
  interface PalletDaoEvent extends Enum {
    ...
    readonly type: 'Voted' | 'Proposed' | 'Approved' | 'Disapproved' | 'Executed' | 'Closed' | 'ClosedByCouncil' | 'CouncilMemberVeto';
  }
  ...
  interface PalletValidatorEvent extends Enum {
    ...
    readonly type: 'Bonded' | 'ValidatorRequestCreated' | 'ValidatorRequestApproved' | 'ValidatorActivated' | 'ValidatorRemoved' | 'NodeValidatorChanged' | 'NodeValidatorRemoved';
  }
  ...
  interface PalletTfgridStorageVersion extends Enum {
    ...
    readonly type: 'V1Struct' | 'V2Struct' | 'V3Struct' | 'V4Struct' | 'V5Struct' | 'V6Struct' | 'V7Struct' | 'V8Struct' | 'V9Struct' | 'V10Struct' | 'V11Struct' | 'V12Struct' | 'V13Struct' | 'V14Struct' | 'V15Struct' | 'V16Struct' | 'V17Struct';
  }
  ...
  interface PalletTftBridgeCall extends Enum {
    ...
    readonly type: 'AddBridgeValidator' | 'RemoveBridgeValidator' | 'SetFeeAccount' | 'SetWithdrawFee' | 'SetDepositFee' | 'SwapToStellar' | 'ProposeOrVoteMintTransaction' | 'ProposeBurnTransactionOrAddSig' | 'SetBurnTransactionExecuted' | 'CreateRefundTransactionOrAddSig' | 'SetRefundTransactionExecuted';
  }
  ...
  interface PalletValidatorCall extends Enum {
    ...
    readonly type: 'CreateValidatorRequest' | 'ActivateValidatorNode' | 'ChangeValidatorNodeAccount' | 'Bond' | 'ApproveValidator' | 'RemoveValidator';
  }
  ...
  interface PalletSmartContractStorageVersion extends Enum {
    ...
    readonly type: 'V1' | 'V2' | 'V3' | 'V4' | 'V5' | 'V6' | 'V7' | 'V8' | 'V9' | 'V10' | 'V11';
  }

  /** @name PalletSmartContractError (266) */
  ...
  interface PalletTftPriceError extends Enum {
    ...
    readonly isIsNotAnAuthority: boolean;
    readonly isWrongAuthority: boolean;
    readonly type: 'ErrFetchingPrice' | 'OffchainSignedTxError' | 'NoLocalAcctForSigning' | 'AccountUnauthorizedToSetPrice' | 'MaxPriceBelowMinPriceError' | 'MinPriceAboveMaxPriceError' | 'IsNotAnAuthority' | 'WrongAuthority';
  }

  /** @name PalletBurningBurn (272) */
  ...
  /** @name PalletCollectiveVotes (277) */
  ...
  /** @name PalletCollectiveError (278) */
  ...
  /** @name PalletMembershipError (280) */
  ...
  /** @name PalletDaoProposalDaoProposal (281) */
  ...
  /** @name PalletDaoProposalDaoVotes (282) */
  ...
  /** @name PalletDaoProposalVoteWeight (284) */
  interface PalletDaoProposalVoteWeight extends Struct {
    readonly farmId: u32;
    readonly weight: u64;
  }

  /** @name PalletDaoError (285) */
  ...
  interface PalletValidatorError extends Enum {
    ...
    readonly type: 'BadOrigin' | 'NotCouncilMember' | 'AlreadyBonded' | 'StashNotBonded' | 'StashBondedWithWrongValidator' | 'CannotBondWithSameAccount' | 'DuplicateValidator' | 'ValidatorNotFound' | 'ValidatorNotApproved' | 'UnauthorizedToActivateValidator' | 'ValidatorValidatingAlready' | 'ValidatorNotValidating';
  }

  /** @name SpRuntimeMultiSignature (288) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (293) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (294) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (295) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (296) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (299) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (300) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (301) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name TfchainRuntimeRuntime (302) */
